  ...
  const STR = {
    it: {
      ...
      rime: {
        ...
        countWords: '{n} parole · finale «{k}»', countWordsEn: '{n} parole', sylTitle: '{n} sillabe',
        emptyMetric: 'Scrivi qualche verso qui sopra per vedere il conteggio.',
        notFound: '“{w}” non è nel dizionario.', tronco: ' (tronco)',
      },
      accordi: {
    ...
    en: {
      ...
      home: {
        ...
        rimeT: 'Rhymes & meter', rimeD: 'English rhyming dictionary based on real pronunciation, plus a syllable counter for your lines.',
      ...
      rime: {
        ...
        dict: 'Rhyming dictionary', word: 'Word', wordPh: 'e.g. ocean',
        rhyme: 'Rhyme', assonance: 'Assonance', counter: 'Syllable counter',
        versesLbl: 'Paste your lines here (one per line)',
        versesPh: 'Walking alone in the night\nthinking of you again\nthe wind carries my town away',
        legend: 'Rhymes use real <b>English pronunciation</b> (CMU dictionary), so <i>love/move</i> correctly don\'t rhyme. The syllable count per line is an estimate.',
        ...
        countWords: '{n} words · ending «{k}»', countWordsEn: '{n} words', sylTitle: '{n} syllables',
        emptyMetric: 'Type some lines above to see the count.',
        notFound: '“{w}” is not in the dictionary.', tronco: ' (oxytone)',
      },
      accordi: {
